...
class ConfigGenerator {
    ...
    getWebpackConfig() {
        ...
        if (this.webpackConfig.useSvelte) {
            // ignore next line since require.resolve is not a require
            // eslint-disable-next-line node/no-unpublished-require
            config.resolve.alias['svelte'] = path.dirname(require.resolve('svelte/package.json'));
        }
        ...
        if (this.webpackConfig.useSvelte) {
            rules.push(applyRuleConfigurationCallback('svelte', {
                ...
                use: {
                    ...
                    options: this.webpackConfig.svelteOptions,
                },
            }));
        }
